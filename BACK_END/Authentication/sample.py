...
detector = cv2.CascadeClassifier(r'BACK_END\Authentication\haarcascade_frontalface_default.xml')
...
while True:
    ...
    for (x,y,w,h) in faces:
        ...
        cv2.imwrite(r"BACK_END\Authentication\Samples\Face." + str(face_id) + '.' + str(count) + ".jpg", converted_image[y:y+h,x:x+w])
